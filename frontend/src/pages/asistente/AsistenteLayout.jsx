...
export default function Layout() {
  ...
  const isDashboardPath = location.pathname === "/supervisor"
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-y-auto bg-gray-100 transition-all">
      ...
      <header className="relative flex items-end shrink-0 pl-6 px-16 bg-white">
            <TabsContainer>
            <Tab to="/asistente"                   label="Registros" />
            <Tab to="/asistente/historicos"        label="Datos históricos" />
            <Tab to="/asistente/registro-paradas"  label="Registro de paradas" />
            </TabsContainer>
        ...
        <div className="absolute right-10 top-3 flex items-center gap-3 z-30">
          ...
          <div className="relative" ref={menuRef}>
            ...
            {isMenuOpen && (
              <UserMenu handleLogout={handleLogout} rol={"Asistente"} index={"AS"}/>
            )}
          </div>
