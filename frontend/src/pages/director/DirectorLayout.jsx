...
import { Calendar, UserRound, History } from "lucide-react"
...
export default function Layout() {
  ...
  const isAsignacionPath = location.pathname === "/director/asignacion-supervisores"
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-y-auto bg-gray-100 transition-all">
        ...
        <div className="absolute right-10 top-3 flex items-center gap-3 z-30">
          ...
          {isAsignacionPath && (
            <button
              ...
              aria-label="Alternar vista histórica"
            >
          ...
          <div className="relative" ref={menuRef}>
            ...
            {isMenuOpen && (
              <UserMenu handleLogout={handleLogout} rol={"Director"} index={"DI"}/>
            )}
          </div>
      ...
      <main className="w-full bg-gray-100 p-6 border-gray-300 border-t-2">
        <Outlet context={{ selectedDate, mostrarHistorico }} />
      </main>
